  ...
  checkout: {
    meta: {
      ...
      defects: [
        ...
        { what: 'Selector de país (<select>) sin etiqueta ni nombre accesible', revealedBy: 'Lector de pantalla', wcag: '4.1.2' },
        { what: 'Error de validación mostrado solo con color rojo', revealedBy: 'Daltonismo', wcag: '1.4.1' },
        { what: 'Botón principal con bajo contraste (texto casi ilegible)', revealedBy: 'Visión reducida', wcag: '1.4.3' },
        { what: 'Textos secundarios (subtítulo, variantes, legal) con contraste mínimo', revealedBy: 'Visión reducida', wcag: '1.4.3' },
        { what: 'Botón de ayuda solo con icono, sin nombre accesible', revealedBy: 'Lector de pantalla', wcag: '4.1.2' },
        { what: 'Orden de encabezados roto (salto directo a <h5>)', revealedBy: 'Lector de pantalla', wcag: '1.3.1' },
        { what: 'Enlace promocional con tabindex positivo y rol ARIA inexistente', revealedBy: 'Teclado', wcag: '2.4.3 / 4.1.2' },
        { what: 'Dos elementos comparten el mismo id (id duplicado)', revealedBy: 'Lector de pantalla', wcag: '4.1.1' },
      ...
      remediation: [
        ...
        { fix: 'Etiqueta el <select> de país y añade autocomplete', wcag: '4.1.2' },
        { fix: 'Muestra los errores con texto e icono, no solo con color rojo', wcag: '1.4.1 / 3.3.1' },
        { fix: 'Sube el contraste del botón principal y de los textos a ≥ 4.5:1', wcag: '1.4.3' },
        { fix: 'Da un nombre accesible al botón de ayuda (aria-label)', wcag: '4.1.2' },
        { fix: 'Corrige el orden de encabezados (<h2> en vez de <h5>)', wcag: '1.3.1' },
        { fix: 'Quita el tabindex positivo y usa roles ARIA válidos', wcag: '2.4.3 / 4.1.2' },
        { fix: 'Asegura ids únicos en toda la página', wcag: '4.1.1' },
  ...
  feed: {
    meta: {
      ...
      defects: [
        ...
        { what: 'Selector de idioma (<select>) sin etiqueta', revealedBy: 'Lector de pantalla', wcag: '4.1.2' },
        { what: 'Un botón anidado dentro de otro botón (interactivo anidado)', revealedBy: 'Teclado', wcag: '4.1.2' },
        { what: 'Encabezado sin texto perceptible (dentro de span aria-hidden)', revealedBy: 'Lector de pantalla', wcag: '1.3.1' },
      ],
      remediation: [
        ...
        { fix: 'Sube el contraste del subtítulo y los metadatos a ≥ 4.5:1', wcag: '1.4.3' },
        { fix: 'Etiqueta el <select> de idioma', wcag: '4.1.2' },
        { fix: 'No anides controles interactivos uno dentro de otro', wcag: '4.1.2' },
        { fix: 'Da texto perceptible a cada encabezado', wcag: '1.3.1' },
      ],
    },
  ...
  reports: {
    meta: {
      ...
      defects: [
        ...
        { what: 'Selector de prioridad (<select>) sin etiqueta', revealedBy: 'Lector de pantalla', wcag: '4.1.2' },
        { what: 'Primer campo con tabindex positivo (orden de foco alterado)', revealedBy: 'Teclado', wcag: '2.4.3' },
        { what: 'El enlace y el primer campo comparten el mismo id (id duplicado)', revealedBy: 'Lector de pantalla', wcag: '4.1.1' },
      ...
      remediation: [
        ...
        { fix: 'Etiqueta el <select> de prioridad', wcag: '4.1.2' },
        ...
        { fix: 'Quita el tabindex positivo y usa ids únicos', wcag: '2.4.3 / 4.1.1' },
  ...
  dashboard: {
    meta: {
      ...
      defects: [
        ...
        { what: 'Botón de reintentar por fila solo con icono, sin nombre accesible', revealedBy: 'Lector de pantalla', wcag: '4.1.2' },
        { what: 'La lista usa un atributo ARIA inexistente (aria-livee)', revealedBy: 'Lector de pantalla', wcag: '4.1.2' },
        { what: 'Título del panel sin texto perceptible (encabezado vacío)', revealedBy: 'Lector de pantalla', wcag: '1.3.1' },
        { what: 'Resumen, hint y latencias con contraste muy bajo', revealedBy: 'Visión reducida', wcag: '1.4.3' },
      ],
      remediation: [
        ...
        { fix: 'Da un nombre accesible al botón de reintentar (aria-label)', wcag: '4.1.2' },
        { fix: 'Usa solo atributos ARIA válidos (aria-live, aria-label)', wcag: '4.1.2' },
        { fix: 'Da texto perceptible al título del panel', wcag: '1.3.1' },
        { fix: 'Sube el contraste de resumen, hint y latencias a ≥ 4.5:1', wcag: '1.4.3' },
      ],
    },
